...
function IconArrowUp({ className }: React.ComponentProps<'svg'>) {
  return (
  <svg 
    clipRule="evenodd" 
    fillRule="evenodd" 
...
function IconInfo({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M128 24a104 104 0 1 0 104 104A104.12 104.12 0 0 0 128 24Zm0 192a88 88 0 1 1 88-88 88.1 88.1 0 0 1-88 88Zm0-128a12 12 0 1 0-12-12 12 12 0 0 0 12 12Zm12 24h-8a8 8 0 0 0-8 8v56a8 8 0 0 0 16 0v-48h4a8 8 0 0 0 0-16Z" />
    </svg>
  );
}
...
export function IconOpenSource({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function IconChartBar({ className, ...props }: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
function IconRefresh({ className, ...props }: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function IconRocket({ className, ...props }: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function IconCompass({ className, ...props }: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function IconHome({ className, ...props }: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
